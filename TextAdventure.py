...
power = ("What power would you like to have? ")
print("Interesting!")
...
time.sleep(3)
#The story
print("In a lost village, there was a kid called", name, ".", name , "feared" , fear , ". But one day he fought against it and won.", hero , "Appeared and reawarded", name, "with something incredible,", hero , "gifted", name , "a superpower! Out of nowhere," , name, "recieved had" , power , )